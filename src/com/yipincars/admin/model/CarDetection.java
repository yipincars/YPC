...
public class CarDetection implements java.io.Serializable {
	...
	/** full constructor */
	public CarDetection(String outsideFrameInfo, String outsideHeadBumper,
			String outsideTailBumper, String outsideLeftMirror,
			String outsideRightMirror, String outsideLeftHeadlight,
			String outsideRightHeadlight, String outsideLeftTaillight,
			String outsideRightTaillight, String outsideWheelCover,
			String outsideAntenna, String outsideHeadScreen,
			String outsideTailScreen, String outsideGrille,
			String outsideHeadGlass, String outsideTailGlass,
			String outsideHeadLeftGlass, String outsideHeadRightGlass,
			String outsideTailRightGlass, String outsideTailLeftGlass,
			String insideDashboard, String insideSteeringWheel,
			String insideInnerMirror, String insideSunvisor,
			String insideGlovebox, String insideRoof,
