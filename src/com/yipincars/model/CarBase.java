...
public class CarBase implements java.io.Serializable {
	...
	private String imageLeft; //左侧图片
	private String imageRightTop; //右上侧图片
	private String imageRightBottom; //右下侧图片
	...
	@Column(name = "image_right_bottom")
